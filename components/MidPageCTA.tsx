...
export default function MidPageCTA({
  ...
  return (
    <section className="bg-accent text-ink px-6 py-14">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          ...
          <p className="mt-2 text-ink/75 text-sm max-w-md">{subhead}</p>
        </div>
        <div className="flex flex-col sm:flex-row gap-3 shrink-0">
          ...
          <a
            ...
            className="border border-ink/40 text-ink px-6 py-3 text-xs font-semibold uppercase tracking-widest rounded-sm hover:bg-ink/10 transition-colors text-center"
          >
            {business.phone}
          </a>
        </div>
