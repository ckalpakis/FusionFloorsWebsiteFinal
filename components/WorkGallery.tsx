      ...
      <div className="max-w-6xl mx-auto">
        <div className="border-t border-accent/30 pt-6 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          {variant === "scroll" && (
            <Link
              href="/work"
              className="shrink-0 border border-accent text-accent text-xs font-semibold uppercase tracking-widest px-5 py-3 hover:bg-accent hover:text-ink transition-colors"
            >
              See full portfolio
            </Link>
          )}
