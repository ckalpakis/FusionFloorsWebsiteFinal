      ...
      <div className="flex items-center justify-between px-6 md:px-10 py-5 md:py-6">
        ...
        <div className="flex items-center gap-8 md:gap-12">
          ...
          <div className="flex items-center gap-3 sm:gap-5 md:gap-6">
            ...
            <Link
              href="/contact"
              className="bg-accent text-ink px-4 sm:px-5 py-2.5 text-xs font-semibold uppercase tracking-widest rounded-sm hover:opacity-90 transition-opacity whitespace-nowrap"
              onClick={() => setOpen(false)}
            >
              Request a Quote
            </Link>
