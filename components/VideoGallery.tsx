              ...
              return (
                <div key={v.label} className="relative aspect-[3/4] overflow-hidden bg-paper/5">
                  <iframe
                    ...
                    allowFullScreen
                  />
                  <span className="absolute bottom-3 left-3 z-10 bg-accent text-ink text-xs font-semibold uppercase tracking-wide px-3 py-1.5 pointer-events-none">
                    {v.label}
                  </span>
                </div>
              );
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  aria-hidden
                >
                  {/* matches the `ink` token — this sits on a bg-paper/90 chip */}
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="#0B1014">
                    <path d="M8 5v14l11-7z" />
                  </svg>
                </span>

                <span className="absolute bottom-3 left-3 bg-accent text-ink text-xs font-semibold uppercase tracking-wide px-3 py-1.5">
                  {v.label}
                </span>
              </button>
            );
