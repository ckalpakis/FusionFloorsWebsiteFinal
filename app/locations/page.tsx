  ...
  return (
    <>
      ...
      <section className="px-6 py-20 max-w-4xl mx-auto">
        ...
        <p className="flex items-center gap-2 text-sm uppercase tracking-widest text-accent-ink">
        ...
        <h1 className="font-display uppercase text-4xl md:text-5xl mt-3 leading-none">
          Where we <span className="text-accent-ink">work.</span>
        </h1>
          ...
          {siteConfig.locations.map((l) => (
            <li key={l.slug}>
              <Link
                ...
                className="group block overflow-hidden rounded border border-ink/10 hover:border-accent-ink transition-colors"
              >
