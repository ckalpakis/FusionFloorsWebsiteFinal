...
// /services/basement-epoxy/tomah. This is the page that actually targets
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-ink text-paper">
        ...
        <div className="relative z-10 px-6 py-20 md:py-28 max-w-4xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Link
              href="/contact"
              className="bg-accent text-ink px-8 py-3 text-xs font-semibold uppercase tracking-widest rounded-sm hover:opacity-90 transition-opacity text-center"
            >
              Get a Free Quote
            </Link>
            <a
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto">
            ...
            <ol className="mt-4 space-y-4">
              {service.process.map((step, i) => (
                <li key={i} className="flex gap-4">
                  <span className="font-display text-accent-ink text-sm shrink-0 pt-0.5">
        ...
        {recentProject && (
          <div className="mt-12 max-w-2xl border-l-2 border-accent-ink pl-6">
            <p className="text-sm uppercase tracking-wide text-accent-ink">Recent project</p>
        ...
        {location.localConditions.length > 0 && (
          <div className="mt-12 max-w-2xl">
            <h2 className="font-display text-xl font-semibold">Building for {location.name}</h2>
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-16 border-t border-accent-ink/25 pt-8">
          <h2 className="font-display text-xl font-semibold">
              ...
              .map((l) => (
                <li key={l.slug}>
                  <Link
                    ...
                    className="inline-block border border-ink/15 rounded-full px-4 py-2 hover:border-accent-ink hover:text-accent-ink transition-colors"
                  >
      ...
      <QuoteForm headingLevel="h2" width="narrow" />
